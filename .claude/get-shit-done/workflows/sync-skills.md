...
INSTALL_JS_GLOBAL="/Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
