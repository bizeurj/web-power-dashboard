...
```
Agent(
  prompt="Read /Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/get-shit-done/templates/SECURITY.md`
