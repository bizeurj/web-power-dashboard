...
<required_reading>
@/Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/get-shit-done/references/ai-frameworks.md
@/Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/agents/gsd-eval-planner.md for instructions.
