...
```bash
INIT=$(node "/Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
