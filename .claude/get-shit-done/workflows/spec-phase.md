...
```bash
INIT=$(node "/Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/get-shit-done/templates/spec.md.
