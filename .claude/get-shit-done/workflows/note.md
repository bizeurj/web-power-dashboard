...
- **Global scope**: `/Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/notes/`)
...
2. Glob `/Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/notes/` — works in any directory
