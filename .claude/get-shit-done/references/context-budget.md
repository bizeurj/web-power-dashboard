...
The keys live in `.claude/settings.json` (project) or `/Users/jbizeur/Projects/Data Dashboard/Web Dashboard/.claude/settings.json` (global) — **not** in `.planning/config.json`:
